...
$shadowedPaths = @(
    ...
    '/src/src/VcsToolkit.Forge/bin',
    '/src/src/VcsToolkit.Forge/obj',
    '/src/src/VcsToolkit.TestKit/bin',
    ...
    '/src/tests/VcsToolkit.Forge.Tests/bin',
    '/src/tests/VcsToolkit.Forge.Tests/obj',
