...
APIs use streamed output, and Git/Jujutsu network operations use a two-second graceful cancellation
window before escalation when their cancellation token fires. It does not use idle timeouts, PTY
sessions, readiness probes, supervisors, or process-group profiles.
